import{a as k,b as S,c as w}from"./Apple books-496f8b96.js";let v=null;async function q(){if(!v)try{v=(await k.get("https://books-backend.p.goit.global/books/top-books")).data}catch(o){throw console.error(o),o}return v}function E(o){const{_id:e,author:t,book_image:s,title:d}=o;return`
