import"./modal-e30033ea.js";function E(){const t=document.getElementById("pagination-numbers"),s=document.getElementById("paginated-list").querySelectorAll("li"),o=document.getElementById("next-button"),l=document.getElementById("prev-button"),m=3,p=Math.ceil(s.length/m);let i=1;const u=e=>{e.classList.add("disabled"),e.setAttribute("disabled",!0)},b=e=>{e.classList.remove("disabled"),e.removeAttribute("disabled")},f=()=>{i===1?u(l):b(l),p===i?u(o):b(o)},h=()=>{document.querySelectorAll(".pagination-number").forEach(e=>{e.classList.remove("active"),Number(e.getAttribute("page-index"))==i&&e.classList.add("active")})},k=e=>{const a=document.createElement("button");a.className="pagination-number",a.innerHTML=e,a.setAttribute("page-index",e),a.textContent=e,t.appendChild(a)},L=()=>{for(let e=1;e<=p;e++)k(e)},c=e=>{i=e,h(),f();const a=(e-1)*m,S=e*m;s.forEach((d,v)=>{d.classList.add("hidden"),d.classList.remove("visible"),v>=a&&v<S&&(d.classList.remove("hidden"),d.classList.add("visible"))})};window.addEventListener("load",()=>{L(),c(1),l.addEventListener("click",()=>{c(i-1)}),o.addEventListener("click",()=>{c(i+1)}),document.querySelectorAll(".pagination-number").forEach(e=>{const a=Number(e.getAttribute("page-index"));a&&e.addEventListener("click",()=>{c(a)})})})}function B(){const t=document.querySelector(".hero-title"),n=document.querySelector(".sidebar");t.textContent==="Shopping List"&&(n.style.display="none")}B();const r=document.querySelector(".shopping-list"),A=localStorage.getItem("booksData"),g=I();function I(){let t;try{return t=JSON.parse(A),t}catch(n){console.error("Error:",n)}}function N(t){const n=t.map(s=>`<li class="sl-item" data-bookId="${s._id}">
