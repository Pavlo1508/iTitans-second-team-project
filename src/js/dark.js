...
const itemOfCategory = document.querySelector('.category-item');
...
function changeTheme() {
    if (switcher.checked) {
        ...
        scrollbar.classList.add('dark-scrollbar');
        itemOfCategory.classList.add('dark-category-item');
        ...
        scrollbar.classList.remove('dark-scrollbar');
        itemOfCategory.classList.remove('dark-category-item');
    }
};
// const shoppingIcon = document.querySelector('.shopping-icon');
// const body = document.body;
